...
const GridItem = ({ number, description, icon }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full p-2 md:p-10 xl:p-5 bg-neutral-800 border-2 border-neutral-200/20 rounded-xl text-neutral-50 space-y-5 lg:space-y-2">
