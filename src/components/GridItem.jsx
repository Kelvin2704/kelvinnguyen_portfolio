...
const GridItem = ({ number, description, icon }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full p-2 bg-neutral-800 border rounded-xl text-neutral-50 space-y-2">
      <div className="font-custom font-black text-7xl text-green-500">{number}+</div>
